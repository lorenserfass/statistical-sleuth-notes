...
`r nrow(case0201)` sparrows were collected after a storm.
...
```
We have `r nrow(case0202)` pairs of identical twins.  In each pair, one twin
is affected by schizophrenia and the other is not.
